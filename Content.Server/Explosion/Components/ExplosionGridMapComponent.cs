...
/// <summary>
/// Stores data for blocked explosion traversal on a <see cref="MapGridComponent"/> entity.
/// </summary>
/// <seealso cref="ExplosionSystem"/>
[RegisterComponent]
[Access(typeof(ExplosionSystem), Other = AccessPermissions.None)]
public sealed partial class ExplosionGridMapComponent : Component
{
    /// <summary>
    ...
    /// <summary>
    ///     Data struct that describes the explosion-blocking explosion blockers on a tile.
    /// </summary>
    public struct TileData
    {
        ...
        /// </summary>
        public required ExplosionDirection BlockedDirections;
    }
