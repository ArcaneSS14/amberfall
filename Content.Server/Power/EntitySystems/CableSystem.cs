...
public sealed partial class CableSystem : EntitySystem
{
    ...
    private void OnInteractUsing(EntityUid uid, CableComponent cable, InteractUsingEvent args)
    {
        ...
        if (cable.CuttingQuality is {} cuttingQuality)
        {
            args.Handled = _toolSystem.UseTool(args.Used, args.User, uid, cable.CuttingDelay, cuttingQuality, new CableCuttingFinishedEvent());
        }
    }
