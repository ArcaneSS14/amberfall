...
/// <summary>
/// Polygon operations used to calculate openings between Z-levels.
/// </summary>
public static class ZLevelApertures
{
    ...
    public static Box2 Bounds(IReadOnlyList<Vector2[]> regions)
    {
    ...
    public static Box2[] CacheBounds(IReadOnlyList<Vector2[]> regions)
    {
    ...
    public static bool IsNear(IReadOnlyList<Vector2[]> regions, Vector2 point, float margin,
