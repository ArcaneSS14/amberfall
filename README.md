...
**Project Apotheosis** — это самостоятельный билд, основанный на [Trauma Station](https://github.com/Trauma-Station/Trauma-Station). Мы стремимся воссоздать атмосферу тёмного фэнтези.
...
Мы всегда рады помощи в разработке, если вы хотите внести свой вклад, присоединяйтесь к [серверу разработки в Discord](https://discord.gg/arcane-ss14). Вы можете помочь нам, решая проблемы из [списка открытых проблем](https://github.com/ArcaneSS14/project-apotheosis/issues) или предлагая свои идеи. Не стесняйтесь задавать вопросы — мы всегда готовы помочь!
...
```shell
git clone https://github.com/ArcaneSS14/project-apotheosis.git
```
